...
public class AmountTest {
	...
	public void TestWithDraw_DifferentCurrency()    {
		...
		try {
			Assertions.assertSame(FunctionnalException.class, hundredEuros.withdrawAmount(hundredUSDollars), "a message");
		} catch (FunctionnalException e) {
			Assertions.assertEquals("The currency of the amount to withdraw : (USD) is not the same than the currency of the balance :EUR", e.getMessage());
